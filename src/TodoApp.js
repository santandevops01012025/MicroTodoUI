...
const GET_TASKS_API_BASE_URL = "http://get-tasks-api.santan.shop";
const DELETE_TASK_API_BASE_URL = "http://delete-task-api.santan.shop";
const CREATE_TASK_API_BASE_URL = "http://add-task-api.santan.shop";
