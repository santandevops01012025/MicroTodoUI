...
const GET_TASKS_API_BASE_URL = "http://get-tasks-api.santansre.shop";
const DELETE_TASK_API_BASE_URL = "http://delete-task-api.santansre.shop";
const CREATE_TASK_API_BASE_URL = "http://add-task-api.santansre.shop";
